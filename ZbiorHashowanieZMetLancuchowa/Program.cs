...
{
    // Zbior na tablicy z hashwaniem z metoda lancuchowa
    ...
    class HashSet
    {
        ...
        // złożoność zależy od długosci listy
        // ale ponieważ gdy mamy K elementów w wzbiorze
        // a nasza funkcja haszująca rozrzuca równomiernie
        // to srednia dlugosc listy K/n a wiec oczekiwana 
        // zlozonosc jest stala O(1)
        ...
        // sprawdza, czy element jest w zbiorze - zlozonosc zalezy od dlugosci wewnetznej listy
        ...
        {
            if (elements[GetHashCode() % N].Contains(m))
            {
