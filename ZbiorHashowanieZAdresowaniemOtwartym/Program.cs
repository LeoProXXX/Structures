...
namespace ZbiorHashowanieZAdresowaniemOtwartym
{
    ...
    class ZbiorAdresowanieOtwarte
    {
        private int[] elements;
        const int N = 100;

        public ZbiorAdresowanieOtwarte()
        {
        ...
        public bool Contains(int m)
        {
            ...
            while (k < N)
            {
                if (elements[(m.GetHashCode() + k) % N] == m)
                {
                    return true;
                }
                k++;
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("Zbior na tablicy z haszowaniem z adresowaniem otwartym");

            ZbiorAdresowanieOtwarte s1 = new ZbiorAdresowanieOtwarte();
            ZbiorAdresowanieOtwarte s2 = new ZbiorAdresowanieOtwarte();
